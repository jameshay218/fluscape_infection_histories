...
## Author: James Hay
## Date: 21 Feb 2023
## Summary: fits the quarterly infection history and antibody kinetics model to the Fluscape titer dataset and generates some summary plots. Uses measurement offsets
...
mcmc_pars <- c("save_block"=100,"thin"=10000,"thin_hist"=50000,"iterations"=50000000,
