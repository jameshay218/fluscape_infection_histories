...
saveWD <- "~/Documents/GitHub/fluscape_infection_histories//data/"
data1=read.csv("~/Documents/GitHub/flu-model/sero_model/datasets/HaNamCohort.csv", as.is=T)
...
write.table(finalDat,paste0(saveWD,"vietnam_data_primary.csv"),sep=",",row.names=FALSE)
