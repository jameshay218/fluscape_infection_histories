...
#antigenic_map <- read.csv("data/antigenic_maps/antigenic_map_fonville_quarterly_clustered_clustered.csv")
...
par_tab <- read.csv(par_tab_file_blank,stringsAsFactors=FALSE)
