...
## Author: James Hay
## Date: 05 Jan 2024
## Summary: fits the quarterly infection history and antibody kinetics model to the simulated fluscape data

run_name_tmp <- paste0(run_name,"_smooth")
...
fluscape_serosolver_main(serosolver_wd,mcmc_pars,
                         ...
                         run_name_tmp, 
                         main_wd,save_wd_tmp, chain_wd_tmp, 
                         buckets, prior_version, n_chains,
                         titre_dat_filename, antigenic_map_file_smooth,par_tab_file_blank,
                         rho_estimates_file,
