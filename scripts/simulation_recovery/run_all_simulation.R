...
save_wd_chain_plots <- paste0(main_wd,"/figures/chain_plots/")
...
# 4. Fit the basic annual resolution model -----------------------------------------------------
mcmc_pars["hist_opt"] <- 0
run_name_tmp <- paste0(run_name, "_annual")
fluscape_serosolver_main(serosolver_wd,
                         mcmc_pars,
                         subset_indivs=subset_indivs,
                         run_name=run_name_tmp, 
...
# 4. Fit the basic annual resolution model,but ignore the meausurement offsets -----------------------------------------------------
run_name_tmp <- paste0(run_name, "_annual_no_offsets")
fluscape_serosolver_main(serosolver_wd,
                         mcmc_pars,
                         subset_indivs=subset_indivs,
                         run_name=run_name_tmp, 
                         ...
                         estimate_measurement_offsets=FALSE,
                         use_measurement_random_effects=FALSE,
                         append_fixed_rho=FALSE,
                         create_prior_func=NULL,
                         proposal_ratios=NULL)

# 5. Fit the annual resolution model but jointly estimate the offset terms ----------------------------------------------------- 
run_name_tmp <- paste0(run_name, "_annual_joint")
fluscape_serosolver_main(serosolver_wd,
                         mcmc_pars,
                         subset_indivs=subset_indivs,
                         run_name=run_name_tmp, 
                         ...
                         solve_likelihood=TRUE,
                         estimate_measurement_offsets=TRUE,
                         use_measurement_random_effects=TRUE,
                         append_fixed_rho=FALSE,
                         create_prior_func=NULL,
                         proposal_ratios=NULL)
...
# 7. Fit the full model with a mixture of per-year and per-quarter times ----------------------------------------------------- 
run_name_tmp <- paste0(run_name, "_mixed")
fluscape_serosolver_main(serosolver_wd,
                         mcmc_pars,
                         subset_indivs=subset_indivs,
                         run_name=run_name_tmp, 
                         ...
                         create_prior_func=NULL,
                         proposal_ratios=NULL,
                        mixed_time_cutoff = 2005)

# 8. Fit the model using the Bedford maps ----------------------------------------------------- 
run_name_tmp <- paste0(run_name, "_bedford_map")
fluscape_serosolver_main(serosolver_wd,
                         mcmc_pars,
                         subset_indivs=subset_indivs,
                         run_name=run_name_tmp, 
