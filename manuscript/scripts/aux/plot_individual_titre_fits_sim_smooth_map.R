...
ggsave_jah(p_titre_fit_comb,figure_wd,"sim_titre_fits_example_smooth_map",width=7,height=8)
...
compare_ar_annual_smooth_map <- compare_ar_annual %>% mutate(Model="Smooth map")
...
ggsave_jah(p_sim_recovery_alt,figure_wd,"p_sim_recovery_all_smooth_map",8,8)
ggsave_jah(p_sim_ar_annual,figure_wd,"p_sim_recovery_all_smooth_map_annual",7,4)
