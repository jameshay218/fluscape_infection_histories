...
ggsave_jah(p_titre_fit_comb,figure_wd,"sim_titre_fits_example_misspecified",width=7,height=8)
...
compare_ar_annual_no_offsets <- compare_ar_annual %>% mutate(Model="No offsets")
...
ggsave_jah(p_sim_recovery_alt,figure_wd,"p_sim_recovery_all_misspecified",8,8)
ggsave_jah(p_sim_ar_annual,figure_wd,"p_sim_recovery_all_misspecified_annual",7,4)
